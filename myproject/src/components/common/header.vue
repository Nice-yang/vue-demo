	...
	<div class="header">
		<el-row :gutter="10">
			...
			<el-col :xs="12" :sm="12" :md="8">
				<div class="search">
					<el-input size="small" placeholder="search for ...">
			...
			<!---->
			<el-col :xs="8" :md="{span:2,offset:4}">
				<div class="header-right">
					<el-col :span="10">
						<!--消息下拉框-->
						<el-dropdown menu-right="start">
							<span>
							...
							<el-dropdown-menu slot="dropdown">
								...
								<el-dropdown-item v-for="dialogs in dialogs">
									<div class="pop-div">
										<span class="pop-image">
											<img :src="dialogs.header" alt="" width="50px" />
										</span>
					...
					<el-col :span="8">
						<el-dropdown menu-align="start">
							...
							<el-dropdown-menu slot="dropdown">
								<el-dropdown-item>
									<span class="pop-title">you hava new tasks!</span>
								</el-dropdown-item>
			...
			<el-col :xs="8" :sm="8" :md="2">
				<div class="user-header">
					<el-dropdown tirgger="click" menu-align="start">
						<img src="../../../static/images/b_header.jpg" alt="" width="50px"/>
						<el-dropdown-menu slot="dropdown">
							<el-dropdown-item> 
   ...
   export default{
   		data() {
   			return {
   				name:'yangyang',
   				dialogs:[
   					{'header':'../../static/images/b_header2.jpg',content:'我在做测试',time:'3'},
   					{'header':'../../static/images/b_header3.jpg',content:'我在做测试',time:'15'},
   					{'header':'../../static/images/b_header.jpg',content:'我在做测试',time:'18'},
   					{'header':'../../static/images/b_header2.jpg',content:'我在做测试',time:'45'},
   				],
   				tasks:[
   					{id:1,rank:1,content:'我在做测试',overTime:'2017/3/9'},
   					{id:2,rank:2,content:'我在做测试',overTime:'2017/3/15'},
   					{id:3,rank:3,content:'我真的的在做测试',overTime:'2017/3/20'},
   				]
   			}
   		},
   		methods:{
